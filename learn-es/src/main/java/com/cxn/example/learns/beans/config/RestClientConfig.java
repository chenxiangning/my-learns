...
public class RestClientConfig {
    ...
    public RestClient getClient() throws KeyStoreException, NoSuchAlgorithmException, KeyManagementException {
        ...
        RestClientBuilder clientBuilder = RestClient.builder(new HttpHost("10.10.196.95", 9200, "http"));
         ...
         *
         * 2. 设置超时时间
         * 多次尝试同一请求时应该遵守的超时。默认值为30秒，与默认套接字超时相同。若自定义套接字超时，则应相应地调整最大重试超时
...
//        });
        ...
        /**
         * 配置通信加密 配置通信加密，有多种方式：setSSLContext、setSSLSessionStrategy和setConnectionManager(它们的重要性逐渐递增)
